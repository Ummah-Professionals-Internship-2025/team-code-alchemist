...
import { mockBarData as barData, mockPieData as pieData, mockLineData as lineData } from "../../data/mockData"; 
...
const Charts = () => {
  ...
  return (
    <Box display="flex" flexWrap="wrap" gap={4} justifyContent="center" p={2}>
      {/* Bar Chart */}
      <Box
        sx={{
          width: "500px",
