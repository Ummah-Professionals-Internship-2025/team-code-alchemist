    ...
    const fetchProfile = async () => {
      ...
      if (docSnap.exists()) {
        ...
        if (data.generalAvailability) {
          const slots = new Set();
          Object.entries(data.generalAvailability).forEach(([day, timeSlots]) => {
    ...
    <div style={{ padding: '20px', color: '#00212C', background: '#E7E8EE', minHeight: '100vh' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <h1 style={{ color: '#007CA6', fontSize: 38, fontWeight: 800, marginBottom: 8 }}>PROFILE</h1>
          <div style={{ color: '#007CA6', fontSize: 20, marginBottom: 16 }}>Manage your personal information</div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1', minWidth: 300 }}>
            ...
            <div style={{ 
              ...
              <h2 style={{ color: '#007CA6', fontWeight: 800, fontSize: 24, marginBottom: 24 }}>Personal Information</h2>
              
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>First Name</label>
                  <input 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Middle Name</label>
                  <input 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Last Name</label>
                  <input 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Email</label>
                  <input 
                    value={profile.email || ''} 
                    disabled 
                    style={{ 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Phone Number</label>
                  <input 
                    name="phone" 
                    value={profile.phone || ''} 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Country</label>
                  <input 
                    name="country" 
            ...
            <div style={{ 
              ...
              <h2 style={{ color: '#007CA6', fontWeight: 800, fontSize: 24, marginBottom: 24 }}>Academic Information</h2>
              
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>University</label>
                  <input 
                    name="university" 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Major</label>
                  <Select
                    name="major"
                    ...
                    onChange={selected => { 
                      setDirty(true); 
                      setProfile({ ...profile, major: selected ? selected.value : '' }); 
                    }}
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Current Grade</label>
                  <Select
                    name="currentGrade"
                    ...
                    onChange={selected => { 
                      setDirty(true); 
                      setProfile({ ...profile, currentGrade: selected ? selected.value : '' }); 
                    }}
                    classNamePrefix="react-select"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Industry</label>
                  <Select
                    isMulti
                    name="industry"
                    ...
                    onChange={selected => { 
                      setDirty(true); 
                      setProfile({ ...profile, industry: selected ? selected.map(opt => opt.value) : [] }); 
                    }}
                    classNamePrefix="react-select"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>Service Looking For</label>
                  <Select
                    isMulti
                    name="serviceLookingFor"
                    options={serviceOptions}
                    value={serviceOptions.filter(opt => (profile.serviceLookingFor || []).includes(opt.value))}
                    onChange={selected => { 
                      setDirty(true); 
                      setProfile({ ...profile, serviceLookingFor: selected ? selected.map(opt => opt.value) : [] }); 
                    }}
                    classNamePrefix="react-select"
            ...
            <div style={{ 
              ...
              <h2 style={{ color: '#007CA6', fontWeight: 800, fontSize: 24, marginBottom: 24 }}>Social Links</h2>
              
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>GitHub</label>
                  <input 
                    name="github" 
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: 8, fontWeight: 600, color: '#007CA6' }}>LinkedIn</label>
                  <input 
                    name="linkedin" 
          ...
          <div style={{ flex: '1', minWidth: 300 }}>
            ...
            <div style={{ 
              ...
              <h2 style={{ color: '#007CA6', fontWeight: 800, fontSize: 20, marginBottom: 16 }}>General Availability</h2>
              <AvailabilityForm 
            ...
            <div style={{ 
              ...
              <h2 style={{ color: '#007CA6', fontWeight: 800, fontSize: 24, marginBottom: 24 }}>Resume</h2>
